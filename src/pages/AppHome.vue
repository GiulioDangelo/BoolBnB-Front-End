      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-6 city-container">
            <img src="../assets/img/cities/roma.jpg" alt="" class="roma" />
          </div>
          <div class="col-6 city-container">
            <img src="../assets/img/cities/napoli.png" alt="" class="napoli" />
          </div>
          <div class="col-4 city-container">
            <img src="../assets/img/cities/milano.jpg" alt="" class="milano" />
          </div>
          <div class="col-4 city-container">
            <img src="../assets/img/cities/firenze.jpg" alt="firenze" />
          </div>
          <div class="col-4 city-container">
            <img src="../assets/img/cities/berlino.jpg" alt="" class="berlino" />
          </div>
        </div>
      </div>
    </router-view>
