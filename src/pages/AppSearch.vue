...
<template>
    ...
    <div class="d-flex flex-column gap-5">
                    ...
                    <form @submit.prevent="getFilteredApartments">
                        <div class="container d-flex flex-column gap-4">
                            ...
                            <div class="row row-cols-1 row-cols-md-2">
                                ...
                                <div class="input_container">
                                    <input class="form-control" type="text" id="address"
                                        ...
                                        @input="validate($event) + addressAutocomplete + saveCoordinate"
                                        :disabled="!country" @keydown.enter.prevent="preventFormSubmitOnEnter" />
                            ...
                            <div class="input_container_split">
                                <input type="range" class="form-range" id="distance" ref="distance"
                                    v-model.number="distance">
                                <input type="number" class="form-control align-self-end" id="distance" min="1" max="100"
                                    ref="distance" step="1" v-model.number="distance" @input="validate"
                            ...
                            <div class="row row-cols-1 row-cols-md-4">
                                ...
                                <div class="input_container_split">
                                    ...
                                    <input class="form-control" id="size" type="number"
                                        placeholder="Numero in metri quadrati" ref="size" v-model.number="size"
                                ...
                                <div class="input_container_split">
                                    ...
                                    <input class="form-control" id="rooms" type="number" placeholder="Numero Camere"
                                        ref="rooms" v-model.number="rooms" @input="validate"
                                        @keydown.enter.prevent="preventFormSubmitOnEnter">
                                    <div class="error"></div>
                                </div>
                                ...
                                <div class="input_container_split">
                                    ...
                                    <input class="form-control" id="beds" type="number" placeholder="Numero Letti"
                                        ref="beds" v-model.number="beds" @input="validate"
                                        @keydown.enter.prevent="preventFormSubmitOnEnter">
                                    <div class="error"></div>
                                </div>
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 justify-content-center align-items-center g-4">
