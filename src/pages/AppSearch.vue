    ...
    <form @submit.prevent="getFilteredApartments">
        <div class="container d-flex flex-column gap-4">
            ...
            <div class="row row-cols-1 row-cols-md-2">
                ...
                <div class="input_container">
                    <input class="form-control" type="text" id="address" placeholder="Inserisci una città o un indirizzo"
                        aria-label="address" name="q" autocomplete="off" ref="address" v-model.trim="address"
            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-md-4">
                    ...
                    <div class="input_container_split">
                        ...
                        <input class="form-control" id="bathrooms" type="number" placeholder="Numero Bagni" ref="bathrooms"
                            v-model.number="bathrooms" @input="validate" @keydown.enter.prevent="preventFormSubmitOnEnter">
                        <div class="error"></div>
                    </div>
                </div>
            </div>
